...
public class User extends BaseEntity {
	...
	public String toString() {
		return "User [firstName=" + firstName + ", lastName=" + lastName + ", email=" + email + ", mobile=" + mobile
				+ ", password=" + password + ", registerNumber=" + registerNumber + ", role=" + role + ", Address="
				+ Address + ", dob=" + dob + ", bloodGroup=" + bloodGroup + ", roomNo=" + roomNo + ", securityDeposit="
				+ securityDeposit + ", adharCard=" + adharCard + ", profilePic=" + profilePic + ", joinDate=" + joinDate
				+ ", isActive=" + isActive + ", isDeleted=" + isDeleted + ", roomType=" + roomType + ", exitDate="
				+ exitDate + ", guardianName=" + guardianName + ", guardianRelation=" + guardianRelation
				+ ", guardianPhone=" + guardianPhone + ", profileImageUrl=" + profileImageUrl + ", aadharImageUrl="
				+ aadharImageUrl + ", photoIdUrl=" + photoIdUrl + ", messActive=" + messActive + ", workOrClgName="
				+ workOrClgName + ", badNumber=" + badNumber + ", rentAmount=" + rentAmount + ", securityAmount="
				+ securityAmount + ", almiraNumber=" + almiraNumber + "]";
	}
